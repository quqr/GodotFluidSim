// Gradient Subtract — WFS gradientSubtractShader compute version.
// Subtracts pressure gradient from velocity: velocity -= vec2(R - L, T - B)
// Obstacle cells output zero velocity.
#[compute]
#version 450
...
layout(set = 1, binding = 0) uniform sampler2D input_velocity;
